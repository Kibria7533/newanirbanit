...
export default function Incomtable() {
        ...
        <TableBody>
          {rows.map((row) => (
            <TableRow key={row.recever}>
              ...
              <TableCell align="right">{<Incomeaction/>}</TableCell>
              <TableCell align="right">{<Incomedialog />}</TableCell>
            </TableRow>
          ))}
          ...
          <TableCell ></TableCell>
          <TableCell ></TableCell>
          <TableCell align="right" >Total Taka :{rows.reduce((acc,item)=> acc + item.price,0)}</TableCell>
